...
Como límite del corte AV2, todavía quedan evidencias reales por completar: Validation Interviews, evaluaciones heurísticas, Video About-the-Team, exposición AV2, coordinación Sprint 3 / AV2 y revisión de evidencias AV2. El Video About-the-Product ya fue publicado y documentado con enlaces, datos de publicación, testimonios incluidos y captura real. Por ello, el informe debe entenderse como una entrega académica avanzada y trazable, con pendientes explícitos de validación y evidencia, no como cierre absoluto del producto.
